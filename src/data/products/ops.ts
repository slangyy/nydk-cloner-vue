...
export const productionPage: ProductPageConfig = {
  ...
  hero: {
    ...
    breadcrumbs: productBreadcrumb("Производственная система"),
...
export const productionCapabilities: readonly ProductionCapability[] = [
  {
    id: "factory",
    title: "Фабрика",
    description: ["Современное производство 3.0", "Интеллектуальная линия комплексного производства"],
    icon: "/assets/products/production/aad9657f-5f6d-40c5-b301-80ec42ebe34e.png",
  },
  {
    id: "equipment",
    title: "Оборудование",
    description: ["Тайвань и Германия", "Высокотехнологичное оборудование из Италии"],
    icon: "/assets/products/production/df95f5ca-2b97-449a-80d2-7d4cedc3db23.png",
  },
  {
    id: "team",
    title: "Команда",
    description: ["Ключевой менеджмент · дизайнеры и разработчики", "Команда · высококвалифицированные мастера"],
    icon: "/assets/products/production/b28d991a-1b04-461a-ad56-977dae31db27.png",
  },
  {
    id: "environment",
    title: "Экологичность",
    description: ["Цеолитовый ротор + RTO", "Установка очистки летучих органических соединений (ЛОС)"],
    icon: "/assets/products/production/98899d2f-4048-4237-a54d-1c2b482eeb6d.png",
  },
  {
    id: "supply",
    title: "Снабжение",
    description: ["Мощная международная система поставок", "Сырье, изготовленное специально для компании"],
    icon: "/assets/products/production/0181bbe5-f534-42bb-8b87-9fbcd95894d5.png",
  },
] as const;

export const productionEquipmentDescription =
  "Современная производственная база 3.0 занимает 260 му (около 17,3 га), площадь зданий составляет 180 000 м². Здесь работают интеллектуальные линии комплексного производства и более 1 000 единиц высокотехнологичного оборудования из Тайваня, Германии и Италии.";
...
export const materialPage: ProductPageConfig = {
  ...
  hero: {
    ...
    imageAlt: "南洋迪克严选木材供应",
    title: "Система материалов",
    subtitle: "材料系统",
    watermark: sharedWatermark,
    breadcrumbs: productBreadcrumb("Система материалов"),
    aspectRatio: [1920, 1080],
  },
} as const;
...
export const servicePage: ProductPageConfig = {
  ...
  hero: {
    ...
    subtitle: "服务系统",
    watermark: sharedWatermark,
    breadcrumbs: productBreadcrumb("Система сервиса"),
    aspectRatio: [1920, 1080],
  },
} as const;
...
export const serviceSteps: readonly ServiceStep[] = [
  {
    id: "experience",
    number: "01",
    title: "Многогранный опыт",
    subtitle: "искренний сервис",
    icon: "/assets/products/service/bb2635d8-d2c0-4f9a-a119-e8938e492651.png",
  },
  {
    id: "measure",
    number: "02",
    title: "Бесплатные замеры",
  ...
  },
  {
    ...
    subtitle: "сервис, которому можно доверят",
  ...
  },
  {
    ...
    subtitle: "интеллектуальный сервис",
  ...
  },
  {
    ...
    subtitle: "обслуживание в одном месте",
  ...
  },
  {
    ...
    subtitle: "сервис без лишних забот",
...
export const servicePowerSlides: readonly ProductCarouselSlide[] = [
  {
    ...
    title: "Полноценная система обслуживания",
    description:
      "Мы создаем замкнутую систему обслуживания в одном месте — от комплексного дизайна и реализации интерьера до последующего сервиса, экономя время клиента благодаря надежной способности воплощать проект.",
  },
  {
    id: "service-capability",
    image: "/assets/products/service/69da60e5-e907-4bdb-9b86-19c14fcd8d71.png",
    imageAlt: "南洋迪克持续家居服务",
    title: "Непрерывная сервисная поддержка",
    description:
      "Мы формируем циклическую систему мебельного сервиса и продолжаем сопровождать клиентов после завершения проекта, включая регулярную организацию хранения, бытовое обслуживание и другие услуги.",
  },
  {
    id: "service-details",
    image: "/assets/products/service/867c5323-6c3a-423d-ba9b-ae891982caed.png",
    imageAlt: "南洋迪克极致服务细节",
    title: "Безупречное внимание к деталям сервиса",
    description:
      "Каждому клиенту — индивидуальный предмет и уникальное решение. Внимание к деталям позволяет точно воспроизвести потребности клиента, выполнить персональный заказ и добиться стопроцентного соответствия результата замыслу.",
  },
] as const;
