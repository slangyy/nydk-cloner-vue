...
export const productNavItems: readonly NavItem[] = [
  { label: "Система дизайна", english: "设计系统", href: "/design" },
  { label: "Производственная система", english: "生产系统", href: "/intelligence" },
  { label: "Технологическая система", english: "工艺系统", href: "/technique" },
  { label: "Интеллектуальная система", english: "智能系统", href: "/Zhijia" },
  { label: "Система готовой мебели", english: "成品系统", href: "/home_decoration_p5" },
  { label: "Система материалов", english: "材料系统", href: "/material" },
  { label: "Готовые решения", english: "整装系统", href: "/FixedInstallation_1" },
  { label: "Система сервиса", english: "服务系统", href: "/SaveWorry" },
] as const;
...
export const mainNavItems: readonly NavItem[] = [
  { label: "NEWNOBEL", english: "新诺博", href: "/ExtremeSystem" },
  // { label: "联系", english: "Contact", href: "/ContactUs.html" },
  { label: "Продукция", english: "产品", href: "#", children: productNavItems },
  {
    label: "Проекты",
    english: "案例",
    href: "/cases",
...
export const systemCards: readonly SystemCard[] = [
  {
    ...
    english: "设计系统",
    description: "Клиент прежде всего: индивидуальный комплексный дизайн-проект для каждого клиента",
  ...
  {
    id: "integrated",
    title: "Комплексная система интерьерного оснащения",
    english: "整装系统",
    description: "Клиент прежде всего: индивидуальный комплексный дизайн-проект для каждого клиента",
