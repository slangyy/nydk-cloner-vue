...
- Split layout: text 33%, image 57.91%; the longer Russian text title uses a
  compact `24-32px` scale, `1.15` line height and `0.02em` letter spacing;
  description 18px/#777/2.6.
...
- Mobile: the first title remains 20px while the longer second title uses
  `16-18px`; subtitle/body 14px; 40px first-block padding; second block stacks
  centered text above image and uses 40px bottom padding.
